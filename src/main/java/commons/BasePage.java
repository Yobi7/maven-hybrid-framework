...
public class BasePage {
    //Tuân theo nguyên tắc của tính đóng gói (Encapsulation) - Che giấu việc khởi tạo
    // Hàm static có thể truy cập trực tiếp từ phạm vi Class - Ko cần khởi tạo đối tượng
    ...
    public void pressKeyToElement(WebDriver driver, String locator, Keys keys, String... castParameter) {
        new Actions(driver).sendKeys(getElement(driver, castParameter(locator, castParameter)), keys).perform();
    }
    ...
    public void clickToElementByJS(WebDriver driver, String locator, String... castParameter) {
        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", getElement(driver, castParameter(locator, castParameter)));
        sleepInSecond(3);
    }
