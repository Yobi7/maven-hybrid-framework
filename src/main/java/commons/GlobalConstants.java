...
public class GlobalConstants {
    ...
    public static final String ADMIN_PASSWORD = "wrqYHGQvTSaUG9AR6&";
    ...
    public static final String RESOURCE_PATH = PROJECT_PATH + SEPARATOR + "src" + SEPARATOR + "test" + SEPARATOR + "resources" + SEPARATOR;
}
